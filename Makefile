...
# FIX: Added -Wno-vla-cxx-extension to disable the warning that was causing the error.
$(TWEAK_NAME)_CFLAGS = -fobjc-arc -Wno-deprecated-declarations -Wno-vla-cxx-extension -DTWEAK_VERSION=$(PACKAGE_VERSION)
